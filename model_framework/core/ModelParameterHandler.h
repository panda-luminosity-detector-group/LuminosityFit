...
public:
	...
	void registerParametrization(std::shared_ptr<ModelPar> model_par,
			std::shared_ptr<Parametrization> parametrization);

	void registerParametrizations(ModelParSet &model_par_set_,
			std::shared_ptr<Parametrization> parametrization);

	void registerParametrizationModel(std::shared_ptr<ModelPar> model_par,
