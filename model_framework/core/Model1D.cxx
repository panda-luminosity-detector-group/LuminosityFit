...
mydouble
Model1D::Integral(const std::vector<DataStructs::DimensionRange> &ranges,
                  mydouble precision) {
...
mydouble Model1D::getDomainLowerBound() { return domain_bounds.first; }
