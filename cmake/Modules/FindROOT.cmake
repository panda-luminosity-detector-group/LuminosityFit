...
if(ROOT_FOUND)
  ...
  foreach(COMPONENT ${rootlibs} ${ROOT_FIND_COMPONENTS})
	...
	message(STATUS "  ${COMPONENT}")
        ...
        if(EXISTS "${ROOT_${UPPERCOMPONENT}_LIBRARY_RELEASE}")
          set_property(TARGET ROOT::${COMPONENT} APPEND PROPERTY
            IMPORTED_CONFIGURATIONS RELEASE)
          set_target_properties(ROOT::${COMPONENT} PROPERTIES
            IMPORTED_LINK_INTERFACE_LANGUAGES_RELEASE "CXX"
            IMPORTED_LOCATION_RELEASE "${ROOT_${UPPERCOMPONENT}_LIBRARY_RELEASE}")
        endif()
	if(EXISTS "${ROOT_${UPPERCOMPONENT}_LIBRARY_DEBUG}")
          set_property(TARGET ROOT::${COMPONENT} APPEND PROPERTY
            IMPORTED_CONFIGURATIONS DEBUG)
          set_target_properties(ROOT::${COMPONENT} PROPERTIES
            IMPORTED_LINK_INTERFACE_LANGUAGES_DEBUG "CXX"
            IMPORTED_LOCATION_DEBUG "${ROOT_${UPPERCOMPONENT}_LIBRARY_DEBUG}")
        endif()
