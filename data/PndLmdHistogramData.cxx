...
PndLmdHistogramData::PndLmdHistogramData(
    ...
    : PndLmdAbstractData(lmd_hist_data_), hist_1d(0), hist_2d(0),
      fit_storage(lmd_hist_data_.fit_storage) {
...
TH1D *PndLmdHistogramData::get1DHistogram() const { return hist_1d; }

TH2D *PndLmdHistogramData::get2DHistogram() const { return hist_2d; }

const std::map<PndLmdFitOptions, std::vector<ModelFitResult>> &
PndLmdHistogramData::getFitResults() const {
  return fit_storage.getFitResults();
}

std::vector<ModelFitResult>
PndLmdHistogramData::getFitResults(const PndLmdFitOptions &fit_options) const {
...
PndLmdHistogramData &PndLmdHistogramData::
operator=(const PndLmdHistogramData &lmd_hist_data) {
