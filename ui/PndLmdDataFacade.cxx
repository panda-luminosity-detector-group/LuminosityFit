...
void PndLmdDataFacade::createResolutions() {
	...
	if (lmd_runtime_config.isAutomaticPrimaryResolutionRangeActive())
		applyAutomaticResolutionDimensionRange(primary_dimension);
	if (lmd_runtime_config.isAutomaticSecondaryResolutionRangeActive())
...
void PndLmdDataFacade::applySelections() {
	...
	LumiFit::LmdDimension selection_dimension = constructDimensionFromConfig(
			sel_dim.second);
