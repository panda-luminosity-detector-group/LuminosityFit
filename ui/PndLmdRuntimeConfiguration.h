...
public:
  ...
  getReferenceAcceptanceResolutionInputDirectory() const;
  ...
  getAcceptanceOffsetsTranformationParameters() const;
  ...
  void setGeneralConfigDirectory(const std::string &general_config_directory_);
