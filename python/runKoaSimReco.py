...
if 0 == "$?" or  2 == "args.force_level":
  ...
  if debug:
    os.system(f"cp {args.path_mc_data}/Koala_MC_${start_evt}.root workpathname/Koala_MC_${start_evt}.root")
    os.system(f"cp {args.path_mc_data}/Koala_Params_${start_evt}.root workpathname/Koala_Params_${start_evt}.root")
