...
void runLmdFit(string input_file_dir, string fit_config_path,
  ...
  lmd_runtime_config.setElasticDataName("lmd_data.root");
  lmd_runtime_config.setAccDataName("lmd_acc_data.root");
  lmd_runtime_config.setResDataName("lmd_res_data.root");
