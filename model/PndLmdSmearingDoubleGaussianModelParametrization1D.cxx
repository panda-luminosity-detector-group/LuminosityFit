...
PndLmdSmearingDoubleGaussianModelParametrization1D::PndLmdSmearingDoubleGaussianModelParametrization1D(
	...
	std::shared_ptr<ParametrizationModel> pm3(new ParametrizationModel(poly_model3));
	model->getModelParameterHandler().registerParametrizationModel(
	...
	std::shared_ptr<ParametrizationModel> pm4(new ParametrizationModel(poly_model4));
	model->getModelParameterHandler().registerParametrizationModel(
	...
	std::shared_ptr<ParametrizationModel> pm5(new ParametrizationModel(poly_model5));
	model->getModelParameterHandler().registerParametrizationModel(
	...
	std::shared_ptr<Model1D> add_model1(
			new AdditionModel1D("gauss_sigma_narrow_poly_model_plus_exp_model_1d", exp_model1,
					poly_model1));
	std::shared_ptr<ParametrizationModel> pm1(new ParametrizationModel(add_model1));
	model->getModelParameterHandler().registerParametrizationModel(
			model->getModelParameterSet().getModelParameter("gauss_sigma_narrow"), pm1);
	...
	std::shared_ptr<ParametrizationModel> pm2(new ParametrizationModel(poly_model2));
	model->getModelParameterHandler().registerParametrizationModel(
			model->getModelParameterSet().getModelParameter("gauss_sigma_wide"), pm2);

	std::shared_ptr<Model1D> poly_model3(
			new PolynomialModel1D("gauss_ratio_narrow_wide_poly_model_1d", 0));
	poly_model3->getModelParameterSet().setModelParameterValue(
			"poly_poly_factor_0", 0.3045);
	std::shared_ptr<ParametrizationModel> pm3(new ParametrizationModel(poly_model3));
	model->getModelParameterHandler().registerParametrizationModel(
			model->getModelParameterSet().getModelParameter("gauss_ratio_narrow_wide"), pm3);
	...
	std::shared_ptr<Model1D> add_model2(
			new AdditionModel1D("gauss_mean_narrow_poly_model_plus_exp_model_1d", exp_model2,
					poly_model4));
	std::shared_ptr<ParametrizationModel> pm4(new ParametrizationModel(add_model2));
	model->getModelParameterHandler().registerParametrizationModel(
			model->getModelParameterSet().getModelParameter("gauss_mean_narrow"), pm4);
	...
	std::shared_ptr<Model1D> add_model3(
			new AdditionModel1D("gauss_mean_wide_poly_model_plus_exp_model_1d", exp_model3,
					poly_model5));
	std::shared_ptr<ParametrizationModel> pm5(new ParametrizationModel(add_model3));
	model->getModelParameterHandler().registerParametrizationModel(
