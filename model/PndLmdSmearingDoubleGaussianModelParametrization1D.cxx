...
PndLmdSmearingDoubleGaussianModelParametrization1D::PndLmdSmearingDoubleGaussianModelParametrization1D(
	...
	exp_model1->getModelParameterSet().setModelParameterValue("exp_exp_factor",
			-0.5409);
	shared_ptr<Model1D> add_model1(
			new AdditionModel1D("gauss_sigma_narrow_poly_model_plus_exp_model_1d", exp_model1,
					poly_model1));
	shared_ptr<ParametrizationModel> pm1(new ParametrizationModel(add_model1));
	model->getModelParameterHandler().registerParametrizationModel(
	...
	exp_model2->getModelParameterSet().setModelParameterValue("exp_exp_factor",
			-0.5409);
	shared_ptr<Model1D> add_model2(
			new AdditionModel1D("gauss_mean_narrow_poly_model_plus_exp_model_1d", exp_model2,
					poly_model4));
	shared_ptr<ParametrizationModel> pm4(new ParametrizationModel(add_model2));
	model->getModelParameterHandler().registerParametrizationModel(
