/*
 * PndLmdE760LikeModelParametrizator.cxx
 *
 *  Created on: Oct 17, 2014
 *      Author: anastasia
 */

#include "PndLmdE760LikeModelParametrization.h"
...
void PndLmdE760LikeModelParametrization::adjustStrictParameters() {
...
void PndLmdE760LikeModelParametrization::adjustNonStrictParameters() {
  ...
  // 				- 2.0 * A1_val * A2_val * (1. / 2. / T1_val + 1. / 2.
  // / T2_val)
  // 				+ A3_val / T2_val) / (A1_val * pow(1.0 - A2_val, 2.0)
  // + A3_val)); sigma_tot->setValue( 		4.0 * sqrt(3.1416 * A1_val * 0.1
  // / pow(5.067, 2.0)) * (1.0 - A2_val)
  // 				* 10.0);
...
void PndLmdE760LikeModelParametrization::parametrize() {
