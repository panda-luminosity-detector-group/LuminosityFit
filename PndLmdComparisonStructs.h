...
struct FitOptionsCompare {
  bool operator()(const PndLmdFitOptions &lhs,
                  const PndLmdFitOptions &rhs) const {
...
struct DataPrimaryDimensionOptionsFilter : public AbstractLmdDataFilter {
  ...
  DataPrimaryDimensionOptionsFilter(LumiFit::LmdDimensionOptions lmd_dim_opt_)
  ...
  void setDimensionOptions(const LumiFit::LmdDimensionOptions &lmd_dim_opt_) {
    lmd_dim_opt = lmd_dim_opt_;
  }
};
...
struct SelectionDimensionsFilterIgnoringSecondaryTrack
    : public AbstractLmdDataFilter {
  ...
  bool check(const PndLmdAbstractData &lmd_abs_data) {
    ...
    std::cout << "checking if " << filtered_selection_dimensions.size()
              << " and " << selection_dimensions.size() << " match"
              << std::endl;
